...
func TestAnalyticsHeadSnippets_Empty(t *testing.T) {
	got := analyticsHeadSnippets(nil)
	if got != "" {
		t.Fatalf("expected empty, got %q", got)
	}
}

func TestAnalyticsHeadSnippets_Cloudflare(t *testing.T) {
	providers := []config.AnalyticsProviderConfig{
		{Provider: "cloudflare", Token: "abc123"},
	}
	got := analyticsHeadSnippets(providers)
...
func TestAnalyticsHeadSnippets_Google(t *testing.T) {
	providers := []config.AnalyticsProviderConfig{
...
func TestAnalyticsHeadSnippets_Plausible(t *testing.T) {
	providers := []config.AnalyticsProviderConfig{
...
func TestAnalyticsHeadSnippets_Fathom(t *testing.T) {
	providers := []config.AnalyticsProviderConfig{
...
func TestAnalyticsHeadSnippets_Multiple(t *testing.T) {
	providers := []config.AnalyticsProviderConfig{
...
func TestAnalyticsHeadSnippets_HTMLEscape(t *testing.T) {
	providers := []config.AnalyticsProviderConfig{
